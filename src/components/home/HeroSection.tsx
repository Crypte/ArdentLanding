...
export default function HeroSection() {
    ...
    return (
        <section className="text-center space-y-8 py-10 lg:py-14">
            {/* Hero principal */}
            <div className="space-y-6">
                <h1 className="font-display text-5xl font-bold italic md:text-8xl lg:text-9xl bg-gradient-to-r from-primary to-tertiary-foreground bg-clip-text text-transparent">
